...
- Now go to your AzureML workspace to create the datastore and aunch Azure Machine Learning Studio (blue button in the main pannel marked "Launch Studio") 
- In the left hand navigation pane of Azure Machine Learning Studio, choose "Datastores".
- Click `+ New datastore`. 
