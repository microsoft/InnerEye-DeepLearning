...
from Tests.ML.test_encoders import get_supervised_imagenet_encoder
...
from InnerEye.ML.configs.histo_configs.classification.templates.CachedTcgaCrckImageNetMIL import CachedTcgaCrckImageNetMIL
from InnerEye.ML.configs.histo_configs.classification.templates.ModularTcgaCrckImageNetMIL import ModularTcgaCrckImageNetMIL
from InnerEye.ML.configs.histo_configs.classification.PandaImageNetMIL import PandaImageNetMIL
...
CONTAINER_DATASET_DIR = {
    ...
    ModularTcgaCrckImageNetMIL: TCGA_CRCK_DATASET_DIR,
    CachedTcgaCrckImageNetMIL: TCGA_CRCK_DATASET_DIR,
}

@pytest.mark.parametrize("container_type", [PandaImageNetMIL,
                                            DeepSMILECrck,
                                            ModularTcgaCrckImageNetMIL,
                                            CachedTcgaCrckImageNetMIL])
