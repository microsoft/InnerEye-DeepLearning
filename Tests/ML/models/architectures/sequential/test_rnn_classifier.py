...
from Tests.ML.util import get_default_azure_config, get_default_checkpoint_handler, model_train_unittest
...
def test_rnn_classifier_via_config_2(test_output_dirs: OutputFolderForTests) -> None:
    ...
    results = model_train_unittest(config, dirs=test_output_dirs)
