...
from InnerEye.ML.utils.model_util import ModelAndInfo, update_model_for_multiple_gpu
...
def test_predict_non_ensemble(batch_size: int, empty_labels: bool) -> None:
    ...
    update_model_for_multiple_gpu(ModelAndInfo(model),
                                  args=config,
...
def test_predict_ensemble(batch_size: int) -> None:
    ...
    model_and_opt_0 = update_model_for_multiple_gpu(ModelAndInfo(model_returns_0),
                                                    args=config,
                                                    execution_mode=ModelExecutionMode.TEST)
    model_returns_0 = model_and_opt_0.model
    model_and_opt_1 = update_model_for_multiple_gpu(ModelAndInfo(model_returns_1),
                                                    args=config,
                                                    execution_mode=ModelExecutionMode.TEST)
