...
### Changed
- ([#573](https://github.com/microsoft/InnerEye-DeepLearning/pull/573)) The console output is no longer written to stdout.txt because AzureML handles that better now
