...
def get_cxr_ssl_transforms(config: CfgNode,
    ...
    (no augmentations)
    """
    train_transforms = create_transform_pipeline_from_config(config, apply_augmentations=True)
    val_transforms = create_transform_pipeline_from_config(config, apply_augmentations=use_training_augmentations_for_validation)
