...
class RSNA_RSNA_BYOL(SSLContainer):
    ...
    def __init__(self, **kwargs):
        super().__init__(dataset_name=SSLDatasetName.RSNAKaggle,
                         linear_head_dataset_name=SSLDatasetName.RSNAKaggle,
                         ...
                         path_augmentation_config=path_encoder_augmentation_cxr)
...
class NIH_RSNA_BYOL(SSLContainer):
    ...
    def __init__(self, **kwargs):
        super().__init__(dataset_name=SSLDatasetName.NIH,
                         linear_head_dataset_name=SSLDatasetName.RSNAKaggle,
                         ...
                         linear_head_augmentations_path=path_linear_head_augmentation_cxr)
