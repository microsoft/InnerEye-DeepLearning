...
class ScalarInferencePipeline(ScalarInferencePipelineBase):
    ...
    def create_from_checkpoint(path_to_checkpoint: Path,
        ...
        """
        model_and_opt = model_util.load_from_checkpoint_and_adjust(config, path_to_checkpoint)
        if model_and_opt.model is None or model_and_opt.checkpoint_epoch is None:
            ...
            return None
        return ScalarInferencePipeline(model_and_opt.model, config, model_and_opt.checkpoint_epoch, pipeline_id)
