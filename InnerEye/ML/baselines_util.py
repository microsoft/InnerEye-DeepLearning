...
def compare_folder_contents(expected: Path, actual: Path, run: Optional[Run] = None):
    """
    Compares a set of files in a folder, against files in either the other folder or files stored in the current
